...
categories:
  - Devnet
---
API mendefinisikan bagaimanan users, developers dan aplikasi lainnya berkomunikasi dengan sebuah komponen suatu aplikasi. Selain menggunakan API bisa menggunakan file, sharng database, dan messaging menggunakan message broker.
